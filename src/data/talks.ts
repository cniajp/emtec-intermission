...
export const talks: Talk[] = [
  ...
  },
  {
    ...
    abstract:
      '分散トレーシングをはじめとするモダンなObservabilityは非常に魅力的ですが、レガシーなシステムや組織の慣習などといった現場の制約との間にギャップを感じたことはありませんか？事業成長の裏で技術的負債を抱えてしまっているMonotaROではこのギャップと向き合い、自分たちに合ったObservabilityのあり方について日々試行錯誤を重ねています。開発チームのユースケースに寄り添い、具体的なアクションにつながるようなテレメトリを小さく仕込む。そんな泥臭い「映えないObservability」について実体験をもとにお話しします。',
    speakers: [
      {
        id: 2,
        name: 'Iwanaga Kazuki',
