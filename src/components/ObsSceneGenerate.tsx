 ...
 * 区切り線シーンを作成
 */
function createSeparatorScenes() {
  return [
    {
      prev_ver: 536870913,
      name: '------',
      uuid: '9228194c-7069-4387-9f2c-833756801bfc',
      id: 'scene',
      versioned_id: 'scene',
      settings: {
        id_counter: 0,
    ...
    },
    {
      prev_ver: 536870913,
      name: '-------',
      uuid: 'c0e828f2-9c57-49ec-9216-b9c3f70f067f',
      id: 'scene',
      versioned_id: 'scene',
      settings: {
        id_counter: 0,
...
/**
 * 固定ソース（CountDown, FUTAなど）を作成
 */
function createFixedSources() {
  return [
    {
      prev_ver: 536870913,
      name: 'CountDown',
      uuid: '097f0455-5eaf-42e4-b60b-72d97743b320',
      id: 'scene',
      versioned_id: 'scene',
      settings: {
        id_counter: 1,
        ...
        items: [
          {
            ...
            source_uuid: 'f40c22eb-67ba-4914-9e02-96316d323fb6',
            visible: true,
            locked: false,
            rot: 0.0,
    ...
    },
    {
      prev_ver: 536870913,
      name: 'FUTA',
      uuid: 'f32a427e-0407-44ec-87e7-38bf66bd0ee6',
      id: 'scene',
      versioned_id: 'scene',
      settings: {
        id_counter: 1,
        ...
        items: [
          {
            name: 'Image_FUTA',
            source_uuid: 'dcad48eb-ec3f-42fa-a976-5d99b417a9da',
            visible: true,
            locked: false,
            rot: 0.0,
            scale_ref: { x: 1920.0, y: 1080.0 },
    ...
    },
    {
      prev_ver: 536870913,
      name: 'Image_FUTA',
      uuid: 'dcad48eb-ec3f-42fa-a976-5d99b417a9da',
      id: 'image_source',
    ...
    },
    {
      prev_ver: 536870913,
      name: 'Movie_CountDown',
      uuid: 'f40c22eb-67ba-4914-9e02-96316d323fb6',
      id: 'ffmpeg_source',
...
export default function ObsSceneGenerate({
  ...
  const tId = normalizeValue(trackId)
  const tName = normalizeValue(trackName)

  // イベント名を構築
  const eventName = `${abbr}_Day${day}_Track${tId}`
  ...
  // 固定シーン（区切り線）を追加
  sources.push(...createSeparatorScenes())
  ...
  // 固定ソースを追加
  sources.push(...createFixedSources())
  ...
  link.download = `obs_scene_${abbr}_day${day}_track${tId}.json`
